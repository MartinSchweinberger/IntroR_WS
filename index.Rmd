...
date: "University of Eastern Finland, Joensuu"
site: bookdown::bookdown_site
bibliography: bibtex.bib
---

```{r uef, echo=FALSE, out.width= "35%", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("https://slcladal.github.io/images/uef.png")
```

# General Information

This workshop was kindly sponsored by the [BOMOCULT Research Community at UEF](https://www.uef.fi/en/research-community/borders-mobilities-and-cultural-encounters-bomocult).
...
If you just want use the text analytics methods without learning R, please feel free to explore the free, online, R notebook-based [Text Analytics Tools](https://ladal.edu.au/tools.html). I will show you how to use them during the workshop.
